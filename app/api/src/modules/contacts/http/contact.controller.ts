...
import { createContact } from '@modules/contacts/application/use-cases/contact-create.use-case'
import { getContact } from '@modules/contacts/application/use-cases/contact-get.use-case'
import { listContacts } from '@modules/contacts/application/use-cases/contact-list.use-case'
import { listContactEvents } from '@modules/contacts/application/use-cases/contact-list-events.use-case'
import { listContactStateChanges } from '@modules/contacts/application/use-cases/contact-list-state-changes.use-case'
import { registerEvent } from '@modules/contacts/application/use-cases/contact-register-event.use-case'
import { changeContactState } from '@modules/contacts/application/use-cases/contact-change-state.use-case'
import { deleteContact } from '@modules/contacts/application/use-cases/contact-delete.use-case'

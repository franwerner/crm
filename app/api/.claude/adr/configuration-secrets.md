# ADR — Configuración y secretos

- **Status:** Accepted
- **Fecha de creación:** 2026-05-17
- **Última actualización:** 2026-05-17
- **Decisores:** ifran
- **Fase:** configuration-secrets
...
**Negativas / trade-offs:** los secretos en prod se manejan vía env vars del entorno (sin secret manager dedicado) — aceptable en esta etapa; revisar al ir a producción.

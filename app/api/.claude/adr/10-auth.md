...
- **Última actualización:** 2026-05-17 (sin roles: RBAC eliminado por decisión de producto — ver Historial)
- **Decisores:** ifran
...
| 2026-05-17 | Resuelta la contradicción con el producto: se elimina RBAC/roles; auth queda solo como autenticación sin autorización por roles (PRD v0.3 §2). User sin columna role. | ifran |

...
Coherente con la regla #7 reescrita de `layers-and-dependencies.md`. Cada slice queda autocontenido: agregar un use-case nuevo se resuelve dentro del bootstrap del slice, sin tocar `app.ts`.

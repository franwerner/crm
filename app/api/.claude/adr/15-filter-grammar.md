# ADR 15 — Gramática de filtros en endpoints de listado
...
| Fecha | Cambio | Por |
|---|---|---|
| 2026-05-24 | Decisión inicial. DNF profundidad 2; wire format con `filter[or][i]`; caps 10/25; invariante soft-delete documentada; `FilterGroupObject` como nombre OpenAPI | ifran |

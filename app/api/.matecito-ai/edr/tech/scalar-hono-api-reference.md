...
- **Exposición:** Scalar + spec abiertos solo en no-prod; **deshabilitados en producción vía flag de entorno** (`../delivery/configuration.md`). Ver `../contracts/api-contract.md`.

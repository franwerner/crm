...
- **Version:** latest estable / sin pinear
- **Status:** Accepted
...
- El motor solo se accede desde el adapter del slice (`*.repository.bun.ts`) vía Drizzle — ver `../data/data-access.md` y las reglas de dependencia en `../structure/layers-and-dependencies.md`.
- Pinear la versión mayor en el setup de infraestructura (docker-compose / proveedor) al inicializar, ej. `16`.

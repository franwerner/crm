...
- Las reglas de dependencia entre capas (ver `../structure/layers-and-dependencies.md`) se podrán enforcar con un linter de imports (ej. `eslint-plugin-boundaries` o `dependency-cruiser`) apoyado en los paths de TS.

...
- La config (`.dependency-cruiser.js`) traduce las 7 reglas de `../structure/layers-and-dependencies.md`. Mantenerla sincronizada si las reglas cambian.

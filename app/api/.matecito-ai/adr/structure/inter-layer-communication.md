...
- **Última actualización:** 2026-05-26 (reversión del patrón de API pública por módulo: el borde cross-slice de lectura pasa a read-port propio del consumidor — ver `layers-and-dependencies.md`/`../delivery/dependency-injection.md`/`read-models-for-lists.md`)
- **Decisores:** ifran

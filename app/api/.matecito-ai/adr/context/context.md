...
- Hono no provee estructura ni DI → la arquitectura es responsabilidad nuestra (ver `../structure/architecture-style.md`, `../structure/layers-and-dependencies.md`, `../delivery/dependency-injection.md`).

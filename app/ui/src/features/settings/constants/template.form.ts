...
// modelProvider options driven by current backend; extend here when new providers are added
...
export const templateCreateForm: FormDescriptor<PostAnalysisTemplatesMutationRequest> = {

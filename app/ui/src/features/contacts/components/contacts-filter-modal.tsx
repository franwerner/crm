...
export function ContactsFilterModal({ open, onOpenChange, committedGroups, onApply }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent size="lg">
        ...
        <DialogDescription>Configurar filtros de contactos</DialogDescription>
        <DialogBody>
          <FilterBuilder schema={contactsFilterSchema} groups={draft} onChange={setDraft} />
        </DialogBody>
        <DialogFooter>

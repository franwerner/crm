...
import { projectExpenseListResponseSchema } from "./projectExpenseListResponseSchema.ts";
import { z } from "zod/v4";

export const getProjectsIdExpensesPathParamsSchema = z.object({
  id: z.string(),
});

export const getProjectsIdExpensesQueryParamsSchema = z
  .object({
    filter: z.optional(
      z.object({
        id: z.optional(
 ...
 */
export const getProjectsIdExpenses200Schema = z.lazy(
  () => projectExpenseListResponseSchema,
);

/**
 * @description Unauthorized.
 */
export const getProjectsIdExpenses401Schema = z.lazy(() => problemSchema);

/**
 * @description Project not found.
 */
export const getProjectsIdExpenses404Schema = z.lazy(() => problemSchema);

export const getProjectsIdExpensesQueryResponseSchema = z.lazy(

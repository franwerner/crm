# ADR 06 — Estrategia de testing (app/ui)
...
Consistente con la decisión ya tomada en `app/api` ADR 06: el proyecto arranca **sin tests** por elección consciente del usuario. No es Not Applicable — es aplazamiento, se reevalúa.
...
| Fecha | Cambio | Por |
|---|---|---|
| 2026-05-17 | Marcado Pending — sin tests por decisión de proyecto; conflicto Strict TDD documentado (cerrado, no re-litigar) | ifran |

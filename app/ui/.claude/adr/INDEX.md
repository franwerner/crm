...
| [15-crud-ui-patterns.md](15-crud-ui-patterns.md) | Accepted | CRUD UI: inline vs modal | Construyas un detail page; agregues edición/creación/borrado de un campo escalar o de una colección de subentidades; dudes entre `InlineField` o modal. |

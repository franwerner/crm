...
- **Versión:** ^2.0.7
- **Status:** Accepted
- **Decidido en fase:** ADR 04 §4.4
- **Fecha:** 2026-05-24

## Por qué la elegimos

Librería de toasts recomendada por shadcn (que deprecó su `Toast` propio). Cubre el feedback de mutaciones sin form visible y errores globales (ADR 04 §4.4). Liviana, accesible y fácil de estilar con tokens.
...
- Los mensajes salen del adaptador RFC 7807 (`toUserMessage`, ADR 04 §4.2).

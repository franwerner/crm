# ADR 01 — Estilo arquitectónico y acoplamiento (app/ui)
...
**Negativas / trade-offs:** requiere disciplina para no meter lógica/fetching en componentes presentacionales (ver regla #4 del ADR 02).

# ADR 08 — Configuración (app/ui)

- **Status:** Accepted
- **Fecha de creación:** 2026-05-17
- **Última actualización:** 2026-05-17
- **Decisores:** ifran
- **Fase del bootstrap:** 5.4
...
- Variables esperadas (mínimo): URL base del API (consumida por kubb/cliente — ver ADR 09), flags por entorno.
- `.env` (gitignored) en dev; variables reales por entorno en build/CI.
- Mismo principio que `app/api` ADR 08 (fallar rápido al startup). Decisión autónoma.

...
**Criterio de pertenencia:** ADRs sobre el acceso a datos: consumo del contrato OpenAPI de `app/api` vía kubb, TanStack Query, convenciones de uso y workflow de regeneración.

...
**Criterio de pertenencia:** ADRs sobre el ensamblado, la configuración por entorno y la prueba del paquete: carga/validación de config (`VITE_*`) y estrategia de testing.
...
| arch-enforcement | Cubierto por `eslint-plugin-boundaries` + `dependency-cruiser` (ver `../tech/eslint-plugin-boundaries.md`, `../tech/dependency-cruiser.md`); sin ADR propio dedicado. |

...
**Criterio de pertenencia:** ADRs sobre seguridad del frontend: autenticación, transporte de credenciales (cookie httpOnly), estado de sesión, protección de rutas y CSRF.
...
| input-validation | Cubierto por validación `zod` en forms (ver `../structure/inter-layer-communication.md`); sin ADR propio. |

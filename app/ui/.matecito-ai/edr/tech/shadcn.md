...
- **Status:** Accepted
- **Decidido en fase:** folder-structure (`../frontend/styling-and-design-system.md`)
- **Fecha:** 2026-05-23
...
- Alias del CLI apuntando a `src/shared/ui` (componentes en kebab-case, ver `../structure/folder-structure.md`).
- Deps satélite que arrastra (no llevan mini-EDR propio):
...
- Mapeo de tokens handoff → esquema shadcn: ver `../frontend/styling-and-design-system.md`.

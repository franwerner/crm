...
Librería de toasts recomendada por shadcn (que deprecó su `Toast` propio). Cubre el feedback de mutaciones sin form visible y errores globales (`../runtime/error-handling.md` §4.4). Liviana, accesible y fácil de estilar con tokens.
...
- Los mensajes salen del adaptador RFC 7807 (`toUserMessage`, `../runtime/error-handling.md` §4.2).

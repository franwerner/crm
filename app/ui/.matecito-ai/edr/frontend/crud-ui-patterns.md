# EDR — CRUD UI patterns: inline para escalares, modal para colecciones de subentidades
...
- **Mantener los dos patrones** (cada feature elige). Descartado: no hay criterio objetivo y produjo la divergencia que motiva este EDR. La regla "modal para colecciones, inline para escalares" sí es objetiva.

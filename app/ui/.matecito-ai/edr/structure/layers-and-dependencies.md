# EDR — Capas y reglas de dependencia (app/ui)
...
El EDR más importante: reglas verificables que Claude respeta y se enforzan con `eslint-plugin-boundaries` / `dependency-cruiser`.

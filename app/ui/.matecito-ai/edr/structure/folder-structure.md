# EDR — Estructura de carpetas y naming (app/ui)
...
La estructura macro quedó en el `layers-and-dependencies.md` (features/ + shared/ + app/). Este EDR define el naming de archivos y cómo se organiza el design-system dentro de `shared/ui`.
